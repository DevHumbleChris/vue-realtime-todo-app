    ...
    <div class="mx-auto max-w-sm my-3 p-3 shadow border border-gray-400 rounded-xl">
        <div class="flex justify-between items-center">
            ...
            <div class="flex justify-evenly items-center space-x-2">
                <CheckBadgeIcon v-if="!todo.isCompleted" class="w-8 text-green-500 cursor-pointer" @click="checkTodo(index)"/>
                <XMarkIcon v-else class="w-8 text-indigo-500 cursor-pointer" @click="checkTodo(index)"/>
